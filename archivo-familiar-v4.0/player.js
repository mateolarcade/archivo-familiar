(function () {
  ...
  function renderDetail(item) {
    ...
    playerContent.innerHTML = "<section class=\"detail-layout\"><aside class=\"detail-poster\"><img src=\"" + escapeAttribute(item.poster) + "\" alt=\"Portada de " + escapeAttribute(item.title) + "\"></aside><article class=\"detail-panel\"><p class=\"eyebrow\">" + escapeHtml(category) + "</p><h1>" + escapeHtml(item.title) + "</h1><p class=\"mobile-location\"><span>Lugar</span><strong>" + escapeHtml(item.location || "No especificado") + "</strong></p><div class=\"detail-meta-grid\"><div class=\"detail-meta-year\"><span>A&ntilde;o</span><strong>" + escapeHtml(item.year) + "</strong></div><div class=\"detail-meta-duration\"><span>Duracion</span><strong>" + escapeHtml(item.duration) + "</strong></div><div class=\"detail-meta-category\"><span>Categoria</span><strong>" + escapeHtml(category) + "</strong></div><div class=\"detail-meta-location\"><span>Lugar</span><strong>" + escapeHtml(item.location || "No especificado") + "</strong></div></div><div class=\"people-block\"><span>Personas que aparecen</span><p>" + escapeHtml(people) + "</p></div><p class=\"detail-description\">" + escapeHtml(item.description) + "</p><button id=\"play-button\" class=\"primary-link play-button\" type=\"button\">Reproducir en celular</button></article></section><section class=\"watch-layout\" aria-label=\"Reproductor de video\"><div id=\"video-frame\" class=\"video-frame\"></div>" + renderAccessCard() + "</section>";
